...
def config():
    ...
    # Text Setting
    vqa_label_size = 3129
    closed_label_size = 3129
    open_label_size = 3129
    mlc_label_size = 14
    max_text_len = 40
    ...
    # Momentum Contrast Setting
    temp = 0.07
    rad_queue_size = 81920  # vqa_rad=81920
    queue_size = 81920
    momentum = 0.995
    alpha = 0.4
    embed_dim = 256
    ...
    ans_token_path = ""
    ans_tokenizer_dict_path = ""
    adj_feat_path = "data/external_data/adj_matrix.pt"
    organ_disease_feat = "data/external_data/organ_disease_info.pt"

    # Retrieval
    retrieval = True
    retrieval_data = '/data/qgking/zxy/MultimodalPromptRetrieval-main/data/ROCO'
    retrieval_batch = 8
    k = 1
...
def task_finetune_vqa_vqa_rad():
    ...
    vqa_label_size = 498
    closed_label_size = 63
    open_label_size = 465

@ex.named_config
def task_finetune_vqa_ovqa():
    exp_name = "task_finetune_vqa_ovqa"
    datasets = ["vqa_ovqa"]
    loss_names = _loss_names({"vqa": 1})
    batch_size = 64
    max_epoch = 50
...
def task_finetune_vqa_slack():
    ...
    vqa_label_size = 222 # num_class 220
